 ...
 */
package me.lins.lindenmayer.i18n;
...
import me.lins.lindenmayer.Config;
...
public class Lang {
    ...
    /**
     * Returns the localized string identified by the given id after the first
     * occurrence of "%s" is replaced by the replacement.
     *
     * @param id
     * @param replacement
     * @return
